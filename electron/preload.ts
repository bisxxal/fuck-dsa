...
const electronAPI = {
  ...
  onUpdateContentDimensions: (callback: (dimensions: { width: number; height: number }) => void) => {
    ipcRenderer.on("update-content-dimensions", (_event, dimensions) => callback(dimensions));
  },
